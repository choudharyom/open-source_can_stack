...
export default function MobileSidebar({ isOpen, setIsOpen, currentStep, setCurrentStep }) {
  const steps = [
  ...
  return (
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as="div" className="fixed inset-0 z-40 md:hidden" onClose={setIsOpen}>
        <Transition.Child
          as={Fragment}
        ...
        >
          <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
            ...
            <div className="flex-shrink-0 flex items-center px-4">
              <h2 className="text-xl font-bold text-blue-800">CAN Stack Steps</h2>
            </div>
